...
.stApp {
    background:
        linear-gradient(rgba(10, 14, 26, 0.94), rgba(10, 14, 26, 0.97)),
...
.hero p { color: #9AA4C0; font-size: 1.15rem; margin-top: 8px; }

.flow { display: flex; justify-content: center; align-items: center; flex-wrap: wrap; gap: 10px; margin: 25px 0 40px 0; }
.flow-step {
    background: linear-gradient(145deg, #141A2E, #0E1424);
    border: 1px solid rgba(0, 229, 255, 0.3);
    border-radius: 12px; padding: 14px 20px; font-size: 0.9rem; color: #E8ECF5;
    box-shadow: 0 0 14px rgba(0, 229, 255, 0.1);
}
.flow-arrow { color: #00E5FF; font-size: 1.4rem; }
...
section[data-testid="stSidebar"] { background: rgba(14, 20, 36, 0.85); border-right: 1px solid rgba(0,229,255,0.15); }
</style>
...
if page == "Dashboard":
    ...
    <div class="flow">
        ...
        <div class="flow-step">Route to Dept</div><div class="flow-arrow">&#8594;</div>
